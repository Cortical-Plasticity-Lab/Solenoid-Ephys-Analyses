...
%
%  properties = utils.getOpt(properties,varargin) 
%  >> properties = utils.getOpt(properties,'name1',val1,'name2',val2,...);
%
...
%
%  properties = utils.getOpt(properties,matchtype,varargin);
%  >> properties = utils.getOpt(properties,0,'name1',val1,...);
%  >> properties = utils.getOpt(properties,1,'name1',val1,...);
%  >> properties = utils.getOpt(properties,2,'name1',val1,...);
%  >> properties = utils.getOpt(properties,3,'name1',val1,...);
%  >> properties = utils.getOpt(properties,4,'name1',val1,...);
%  >> properties = utils.getOpt(properties,5,'name1',val1,...);
%
...
%   properties = utils.getOpt(properties,'aspect',0.76,'file','mydata.dat')
% would return:
%   properties =
%         zoom: 1
%       aspect: 0.7600
...
if mod(nPropArgs,2)~=0
   error(['SOLENOID:' mfilename ':BadFormat'],...
