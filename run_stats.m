...
% DEFINE MODELS HERE:
mdlspec_str_main = "peakVal ~ 1 + Area*Type*Lesion_Volume*peakTime + Area*Depth + (-1 + peakTime|BlockID) + (-1 + (Solenoid_Onset__Exp + Solenoid_Offset__Exp + ICMS_Onset__Exp)*peakTime|AnimalID)";
